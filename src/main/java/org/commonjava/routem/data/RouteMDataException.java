...
public class RouteMDataException
    extends Exception
{
    ...
    public RouteMDataException( final String message, final Throwable cause, final Object... params )
    {
        super( message, cause );
        this.params = params;
    }

    public RouteMDataException( final String message, final Object... params )
    {
        super( message );
        this.params = params;
    }
